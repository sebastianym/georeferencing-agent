      ...
      <div className="flex w-full max-w-2xl flex-col gap-10">
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <p className="max-w-xl text-balance text-muted-foreground">
            Valida una dirección con nuestro motor de geocodificación, deja que
            un agente de IA la optimice y compara la precisión antes y después.
          </p>
        ...
        <Card className="shadow-sm">
          <CardHeader>
            ...
            <CardDescription>
              Probá con una dirección individual o cargá un archivo masivo.
            </CardDescription>
          </CardHeader>
          <CardContent>
